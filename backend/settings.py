...
SECRET_KEY = "django-insecure-+fz)^_6bwe)c1n+2a3h*g#r2xu0_bpeahb8uch$zsgwyv*me^u"
...
STATICFILES_DIRS = [ # we can configure multiple static files.
            BASE_DIR / 'static',
            BASE_DIR / 'frontend/build/static' #this will get added once we convert react app into build.
            ]
